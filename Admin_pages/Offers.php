...
$stmt = mysqli_prepare($conn, "SELECT * FROM offers ;");
// Execute the query
...
if(isset($_POST['delete_product']) && !empty($_POST['delete_product'])){
    echo "yessss";
    $offer_id = filter_var($_POST['product_id'], FILTER_SANITIZE_NUMBER_INT);
    $stmt2 = mysqli_prepare($conn,"UPDATE `product` SET Offer_id = '0'  WHERE Offer_id='$offer_id'");
    if(mysqli_stmt_execute($stmt2)){
        $stmt = mysqli_prepare($conn,"DELETE FROM `offers` WHERE Offer_id='$offer_id'");
...
if (isset($_POST['insertBtn'])) {
    ...
    //add new service
    $sql = $conn->prepare("INSERT INTO `offers`(`Value`, `Offer_name`)  VALUES ('$value','$name')");

    if ($sql->execute()) {
        echo "offer added successfully <br>";
    } else
        echo "offer added failed<br>";
        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                style="margin-left: auto; margin-right: 0 !important; padding-right: 15px; font-size: 20px;">
                    ...
                    <li><a href="#" class="nav-link px-2 text-warning"><strong>العروض</strong></a></li>
                    <li><a href="Coupons_displayAll.php" class="nav-link px-2 text-black">الكوبونات</a></li>
                    <li><a href="Slider_DisplayAll" class="nav-link px-2 text-black">الخلفيات</a></li>
                </ul>
            </div>
        </div>
    </header>
            ...
            <h1>العروض</h1><br>
                ...
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        style="background-color:#af9d80 !important; border: 7px solid #af9d80; border-radius: 7px; padding: 1px 7px !important;"  
                            data-toggle="modal" data-target="#deleteEmployeeModal" data-productid="<?php echo $row['Offer_id']; ?>">حذف  </button></td>
                            <input type="hidden" name="product_id" value="<?php echo $row['Offer_id']; ?>"/>
                ...
                <div style="display: flex; align-items: center; justify-content: center; margin-top: 30px; ">
                    <button type="button" class="btn btn-dark btn-lg px-4 me-md-2 ">
                         <a href="#addEmployeeModal"  data-toggle="modal"  style="color:white; text-decoration: none;">إضافة عرض جديد</a>
                    </button>
                </div>          
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" dir="rtl">
                ...
                <br>
                <div class="form-group">
                    <label style=" font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: 600;">ادخل رمز العرض</label>
						...
						<div class="modal-dialog" role="document">
                            ...
                            <form method="post" action="">
								<div class="modal-header">
									<h5 class="modal-title" dir="rtl" style=" font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: 700;" dir="rtl">حذف عرض</h5>
								</div>
								<div class="modal-body">
									<p style=" font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: 600;">هل انت متأكد من حذف هذا العرض ؟</p>
								...
								<div class="modal-footer">
                                    ...
                                    <button type="submit" name="deleteBtn" class="btn btn-success" 
                                    style="border: none; background-color: #af9d80; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: 600;">حذف</button>
								</div>
                            </form> 
							</div>
						</div>
