...
<body>
    ...
    <div class="login">
        <div class="wapper">
            <center>
                 <img src="assets/img/Warning-sign.png"  style=" width:60px;"><br><br>
                 <h4 class="text-center" style="color:red;"><strong> يجب عليك تسجيل الدخول لمتابعة التسوق </strong></h4>
            </center><br>
            <form action="login.php" method="post">
                <h1 Style="color:#033135;">تسجيل الدخول</h1>
                <?php if (isset($error)) {
                    echo "<span class='error-message'>$error</span>"; 
                    } ?> 

                <div class="input-box">
                    <input type="email" placeholder="البريد الإلكتروني" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required name="email" id="email"  value="<?php if (isset($_COOKIE["email"])) { echo $_COOKIE["email"]; } ?>">
                    <i class='bx bxs-user'></i>
                </div>
                <div class="input-box">
                    <input type="password" placeholder="كلمة المرور" required name="password" id="password" value="<?php if (isset($_COOKIE["password"])) { echo $_COOKIE["password"]; } ?>">
                    <i class='bx bxs-lock-alt'></i>
                </div>
                <div class="remembr-forget">
                    <label for="remember-me">
                        <input type="checkbox" id="remember-me" name="remember_me" <?php if (isset($_COOKIE["email"])) { echo "checked"; } ?>>تذكرني
                    </label>
